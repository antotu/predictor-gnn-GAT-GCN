...
rz(-pi) q[13];
sx q[13];
rz(2.62367756949068) q[13];
sx q[13];
rz(-pi) q[14];
sx q[14];
rz(2.768840689264116) q[14];
sx q[14];
cx q[13],q[14];
cx q[12],q[13];
cx q[11],q[12];
...
rz(-pi) q[0];
sx q[0];
rz(3.024856466417684) q[0];
sx q[0];
rz(-pi) q[1];
sx q[1];
rz(2.8083835507471395) q[1];
sx q[1];
rz(-pi) q[2];
sx q[2];
rz(2.5829293176330133) q[2];
sx q[2];
rz(-pi) q[3];
sx q[3];
rz(2.483374749268412) q[3];
sx q[3];
rz(-pi) q[4];
sx q[4];
rz(3.1386905420177538) q[4];
sx q[4];
rz(-pi) q[5];
sx q[5];
rz(2.5779554009015886) q[5];
sx q[5];
rz(-pi) q[6];
sx q[6];
rz(2.807520435026709) q[6];
sx q[6];
rz(-pi) q[7];
sx q[7];
rz(2.724835650758335) q[7];
sx q[7];
rz(-pi) q[8];
sx q[8];
rz(2.625899428928202) q[8];
sx q[8];
rz(-pi) q[9];
sx q[9];
rz(3.1186800797997263) q[9];
sx q[9];
rz(-pi) q[10];
sx q[10];
rz(2.151442594395623) q[10];
sx q[10];
rz(-pi) q[11];
sx q[11];
rz(2.344965888156196) q[11];
sx q[11];
rz(-pi) q[12];
sx q[12];
rz(2.422898586459297) q[12];
sx q[12];
rz(-pi) q[13];
sx q[13];
rz(2.5181729602121905) q[13];
sx q[13];
rz(-pi) q[14];
sx q[14];
rz(2.3748009197277034) q[14];
sx q[14];
