...
rz(-pi) q[11];
sx q[11];
rz(2.8728363486483968) q[11];
sx q[11];
rz(-pi) q[12];
sx q[12];
rz(2.926584941316607) q[12];
sx q[12];
cx q[11],q[12];
cx q[10],q[11];
cx q[9],q[10];
...
rz(-pi) q[0];
sx q[0];
rz(2.899966219478018) q[0];
sx q[0];
rz(-pi) q[1];
sx q[1];
rz(2.169584633590495) q[1];
sx q[1];
rz(-pi) q[2];
sx q[2];
rz(2.451888617172842) q[2];
sx q[2];
rz(-pi) q[3];
sx q[3];
rz(2.3937397093104122) q[3];
sx q[3];
rz(-pi) q[4];
sx q[4];
rz(2.303095483415862) q[4];
sx q[4];
rz(-pi) q[5];
sx q[5];
rz(3.1153314089160764) q[5];
sx q[5];
rz(-pi) q[6];
sx q[6];
rz(2.5835245852544793) q[6];
sx q[6];
rz(-pi) q[7];
sx q[7];
rz(2.341374356482894) q[7];
sx q[7];
rz(-pi) q[8];
sx q[8];
rz(2.1559167581662635) q[8];
sx q[8];
rz(-pi) q[9];
sx q[9];
rz(2.997125158285889) q[9];
sx q[9];
rz(-pi) q[10];
sx q[10];
rz(2.6968865674886198) q[10];
sx q[10];
rz(-pi) q[11];
sx q[11];
rz(3.1165499435885717) q[11];
sx q[11];
rz(-pi) q[12];
sx q[12];
rz(2.635545926843334) q[12];
sx q[12];
