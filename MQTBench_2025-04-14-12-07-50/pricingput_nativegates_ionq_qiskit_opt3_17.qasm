...
rx(-pi/2) q[0];
ry(pi/2) q[0];
ry(1.9608015459530321) q[8];
rxx(pi/2) q[0],q[8];
rx(-3*pi/2) q[0];
rx(-pi/2) q[8];
ry(0.002693862540588401) q[8];
rxx(pi/2) q[0],q[8];
rx(-pi/2) q[8];
ry(-0.005387725081176802) q[8];
rxx(pi/2) q[1],q[8];
rx(-pi/2) q[8];
ry(0.005387725081176802) q[8];
rxx(pi/2) q[1],q[8];
...
rz(-pi) q[3];
rx(-pi/2) q[8];
ry(-0.043101800649414414) q[8];
rxx(pi/2) q[4],q[8];
rx(-pi/2) q[8];
ry(0.043101800649414414) q[8];
rxx(pi/2) q[4],q[8];
rx(-pi/2) q[8];
ry(-0.08620360129882883) q[8];
rxx(pi/2) q[5],q[8];
rx(-pi/2) q[8];
ry(0.08620360129882883) q[8];
rxx(pi/2) q[5],q[8];
...
rz(-pi/4) q[9];
rxx(pi/2) q[7],q[9];
rz(-1.6656737559283865) q[9];
ry(2.9526861374208635) q[9];
rz(0.09487742913346198) q[9];
rxx(pi/2) q[8],q[9];
rz(-pi) q[8];
rx(-pi/2) q[8];
rz(-3.00234244309675) q[9];
ry(2.8657538013690944) q[9];
rz(-0.13925021049304043) q[9];
rxx(pi/2) q[8],q[9];
rz(-pi/2) q[8];
ry(2.7475466406207723) q[8];
rxx(pi/2) q[0],q[8];
rx(-pi/2) q[8];
rz(-pi/4) q[8];
rz(0.1914627095943593) q[9];
ry(1.3827495974680972) q[9];
rz(-2.3743045583246865) q[9];
rxx(pi/2) q[9],q[8];
rx(-pi/2) q[8];
rz(pi/4) q[8];
rxx(pi/2) q[0],q[8];
...
rx(-5*pi/4) q[9];
rxx(pi/2) q[9],q[8];
rz(2.1862760354659923) q[8];
ry(2*pi/3) q[8];
rz(2.52611294491885) q[8];
rxx(pi/2) q[9],q[0];
rx(-pi/2) q[0];
rz(-pi/4) q[0];
rxx(pi/2) q[9],q[0];
rx(-pi/2) q[0];
ry(pi/2) q[0];
rz(-0.5687507836963981) q[9];
ry(0.9958504533958025) q[9];
rz(2.4366782453048454) q[9];
rxx(pi/2) q[8],q[9];
rz(-pi) q[8];
rx(-pi/2) q[8];
rz(-3.141116441436015) q[9];
ry(3.140640229390774) q[9];
rz(-0.0004762121532357888) q[9];
rxx(pi/2) q[8],q[9];
rz(-1.570796326796867) q[8];
ry(2.3548475589220517) q[8];
rz(pi) q[8];
rxx(pi/2) q[0],q[8];
rx(-pi/2) q[0];
rx(-pi/2) q[8];
rz(-pi/4) q[8];
rz(-2.6102407422027936) q[9];
ry(2.039789015466051) q[9];
rz(-0.655572181082201) q[9];
rxx(pi/2) q[9],q[8];
rx(-pi/2) q[8];
rz(pi/4) q[8];
rxx(pi/2) q[0],q[8];
...
rxx(pi/2) q[9],q[0];
rx(-pi/2) q[0];
rz(-2.37632425283466) q[9];
ry(1.3728040466386902) q[9];
rz(0.20199142358484767) q[9];
rxx(pi/2) q[8],q[9];
rz(-pi) q[8];
rx(-pi/2) q[8];
rz(-3.140640229066644) q[9];
ry(3.1396878054077435) q[9];
rz(-0.0009524245228562656) q[9];
rxx(pi/2) q[8],q[9];
rz(pi/2) q[8];
ry(-2.358888352732933) q[8];
rz(-1.1820687615199996) q[9];
ry(2.317464396293219) q[9];
rz(-2.8702747054820783) q[9];
ry(-pi/2) q[16];
rz(-pi/4) q[16];
rxx(pi/2) q[7],q[16];
rx(-pi/2) q[16];
...
rx(-pi/2) q[1];
ry(pi/2) q[1];
rz(0.7637542307708549) q[9];
ry(1.7758960677726352) q[9];
rz(-0.20955522154104544) q[9];
rxx(pi/2) q[8],q[9];
rz(-pi) q[8];
rx(-pi/2) q[8];
rz(-3.140640229066644) q[9];
...
rxx(pi/2) q[8],q[9];
rz(pi/2) q[8];
ry(-2.3535006276517567) q[8];
rxx(pi/2) q[1],q[8];
rx(-pi/2) q[1];
rx(-pi/2) q[8];
rz(-pi/4) q[8];
rz(1.168625023124517) q[9];
ry(0.8269252445917834) q[9];
rz(0.28043517055093004) q[9];
rxx(pi/2) q[9],q[8];
rx(-pi/2) q[8];
rz(pi/4) q[8];
rxx(pi/2) q[1],q[8];
...
ry(pi/2) q[1];
rz(-pi/2) q[1];
rz(-0.5460212707072314) q[9];
ry(2.1671035414076947) q[9];
rz(-2.395561720048174) q[9];
rxx(pi/2) q[8],q[9];
rz(-pi) q[8];
rx(-pi/2) q[8];
rz(-3.139687802815776) q[9];
ry(3.1377829589536086) q[9];
rz(-0.0019048507738168574) q[9];
rxx(pi/2) q[8],q[9];
rz(-pi/2) q[8];
ry(2.350806765111168) q[8];
rxx(pi/2) q[2],q[8];
rx(-pi/2) q[2];
rx(-pi/2) q[8];
rz(-pi/4) q[8];
rz(-0.4959091624072429) q[9];
ry(2.014922865207865) q[9];
rz(0.671200093491946) q[9];
rxx(pi/2) q[9],q[8];
rx(-pi/2) q[8];
rz(pi/4) q[8];
rxx(pi/2) q[2],q[8];
...
rx(-pi/2) q[2];
ry(pi/2) q[2];
rz(-2.621230108725152) q[9];
ry(0.9526914274879335) q[9];
rz(0.7909930839216734) q[9];
rxx(pi/2) q[8],q[9];
rz(-pi) q[8];
rx(-pi/2) q[8];
rz(-3.139687802815776) q[9];
...
rxx(pi/2) q[8],q[9];
rz(-pi/2) q[8];
ry(2.3615822152735224) q[8];
rxx(pi/2) q[2],q[8];
rx(-pi/2) q[2];
rx(-pi/2) q[8];
rz(-pi/4) q[8];
rz(-0.45918663101511337) q[9];
ry(1.9879969979174363) q[9];
rz(-2.4550590492816884) q[9];
rxx(pi/2) q[9],q[8];
rx(-pi/2) q[8];
rz(pi/4) q[8];
rxx(pi/2) q[2],q[8];
...
ry(pi/2) q[2];
rz(-pi/2) q[2];
rz(2.8715266212506494) q[9];
ry(2.317839675086881) q[9];
rz(-1.957681036904443) q[9];
rxx(pi/2) q[8],q[9];
rz(-pi) q[8];
rx(-pi/2) q[8];
rz(-3.1377829382185762) q[9];
ry(3.1339732781407967) q[9];
rz(-0.0038097153711253995) q[9];
rxx(pi/2) q[8],q[9];
rz(pi/2) q[8];
ry(-2.3669699403546978) q[8];
rxx(pi/2) q[3],q[8];
rx(-pi/2) q[3];
rx(-pi/2) q[8];
rz(-pi/4) q[8];
rz(2.940633356288309) q[9];
ry(1.3737763581568792) q[9];
rz(2.3761217242763886) q[9];
rxx(pi/2) q[9],q[8];
rx(-pi/2) q[8];
rz(pi/4) q[8];
rxx(pi/2) q[3],q[8];
...
rx(-pi/2) q[3];
ry(pi/2) q[3];
rz(-2.4640961794716207) q[9];
ry(2.00419768674634) q[9];
rz(-0.4810883360002376) q[9];
rxx(pi/2) q[8],q[9];
rz(-pi) q[8];
rx(-pi/2) q[8];
rz(-3.1377829382185762) q[9];
...
rxx(pi/2) q[8],q[9];
rz(-pi/2) q[8];
ry(2.3669699403547) q[8];
rxx(pi/2) q[3],q[8];
rx(-pi/2) q[3];
rx(-pi/2) q[8];
rz(-pi/4) q[8];
rz(-2.3777127453089104) q[9];
ry(2.1759493840098743) q[9];
rz(2.6056607063188144) q[9];
rxx(pi/2) q[9],q[8];
rx(-pi/2) q[8];
rz(pi/4) q[8];
rxx(pi/2) q[3],q[8];
...
ry(pi/2) q[3];
rz(-pi/2) q[3];
rz(3.060908798093413) q[9];
ry(0.788667307445391) q[9];
rz(1.6850250199429713) q[9];
rxx(pi/2) q[8],q[9];
rz(-pi) q[8];
rx(-pi/2) q[8];
rz(-3.133973112259535) q[9];
ry(3.1263540132808987) q[9];
rz(-0.007619541330211366) q[9];
rxx(pi/2) q[8],q[9];
rz(pi/2) q[8];
ry(-2.3777453905170516) q[8];
rxx(pi/2) q[4],q[8];
rx(-pi/2) q[8];
rz(-pi/4) q[8];
rz(0.05730126555366155) q[9];
ry(1.5135889027711473) q[9];
rz(-2.3578344146118244) q[9];
rxx(pi/2) q[9],q[8];
rx(-pi/2) q[8];
rz(pi/4) q[8];
rxx(pi/2) q[4],q[8];
...
rx(-pi/2) q[4];
ry(pi/2) q[4];
rz(-0.7133819241086963) q[9];
ry(1.2086457399096857) q[9];
rz(2.753028361303195) q[9];
rxx(pi/2) q[8],q[9];
rz(-pi) q[8];
rx(-pi/2) q[8];
rz(-3.133973112259535) q[9];
...
rxx(pi/2) q[8],q[9];
rz(pi/2) q[8];
ry(-2.334643589867638) q[8];
rxx(pi/2) q[4],q[8];
rx(-pi/2) q[4];
rx(-pi/2) q[8];
rz(-pi/4) q[8];
rz(-2.2568692147493117) q[9];
ry(2.2293186060627965) q[9];
rz(-0.46447628175273836) q[9];
rxx(pi/2) q[9],q[8];
rx(-pi/2) q[8];
rz(pi/4) q[8];
rxx(pi/2) q[4],q[8];
...
rx(-pi/2) q[4];
ry(pi/2) q[4];
rz(-2.3729312165938685) q[9];
ry(1.75173595108298) q[9];
rz(-0.18397653174754547) q[9];
rxx(pi/2) q[8],q[9];
rz(-pi) q[8];
rx(-pi/2) q[8];
rz(-3.126352686187646) q[9];
ry(3.111116257752198) q[9];
rz(-0.015239967402122634) q[9];
rxx(pi/2) q[8],q[9];
rz(pi/2) q[8];
ry(-2.3992962908417583) q[8];
rxx(pi/2) q[5],q[8];
rx(-pi/2) q[5];
rx(-pi/2) q[8];
rz(-pi/4) q[8];
rz(-1.927076097964351) q[9];
ry(2.3237883876370056) q[9];
rz(2.89238949439833) q[9];
rxx(pi/2) q[9],q[8];
rx(-pi/2) q[8];
rz(pi/4) q[8];
rxx(pi/2) q[5],q[8];
...
rx(-pi/2) q[5];
ry(pi/2) q[5];
rz(-2.518829874087378) q[9];
ry(1.0562815522507438) q[9];
rz(0.6007982649046144) q[9];
rxx(pi/2) q[8],q[9];
rz(-pi) q[8];
rx(-pi/2) q[8];
rz(-3.126352686187646) q[9];
...
rxx(pi/2) q[8],q[9];
rz(-pi/2) q[8];
ry(2.399296290841759) q[8];
rxx(pi/2) q[5],q[8];
rx(-pi/2) q[5];
rx(-pi/2) q[8];
rz(-pi/4) q[8];
rz(-0.630315153173659) q[9];
ry(2.103384789937515) q[9];
rz(-2.5335885190321763) q[9];
rxx(pi/2) q[9],q[8];
rx(-pi/2) q[8];
rz(pi/4) q[8];
rxx(pi/2) q[5],q[8];
...
ry(pi/2) q[5];
rz(-pi/2) q[5];
rz(2.658254581967938) q[9];
ry(2.2166504511820073) q[9];
rz(-2.287944540834981) q[9];
rxx(pi/2) q[8],q[9];
rz(-pi) q[8];
rx(-pi/2) q[8];
rz(-3.1111056396200354) q[9];
ry(3.080646942313747) q[9];
rz(-0.0304870139697484) q[9];
rxx(pi/2) q[8],q[9];
rz(pi/2) q[8];
ry(-2.442398091491174) q[8];
rxx(pi/2) q[6],q[8];
rx(-pi/2) q[6];
rx(-pi/2) q[8];
rz(-pi/4) q[8];
rz(2.7304272347279994) q[9];
ry(1.1905676641840548) q[9];
rz(2.43640934518754) q[9];
rxx(pi/2) q[9],q[8];
rx(-pi/2) q[8];
rz(pi/4) q[8];
rxx(pi/2) q[6],q[8];
...
rx(-pi/2) q[6];
ry(pi/2) q[6];
rz(0.1243065895499651) q[9];
ry(0.7932048366542473) q[9];
rz(1.3945414839214596) q[9];
rxx(pi/2) q[8],q[9];
rz(-pi) q[8];
rx(-pi/2) q[8];
rz(-3.1111056396200354) q[9];
...
rxx(pi/2) q[8],q[9];
rz(pi/2) q[8];
ry(-2.269990888893516) q[8];
rxx(pi/2) q[6],q[8];
rx(-pi/2) q[6];
rx(-pi/2) q[8];
rz(-pi/4) q[8];
rz(3.0527754496576334) q[9];
ry(1.4823273822830296) q[9];
rz(-0.7814642354449441) q[9];
rxx(pi/2) q[9],q[8];
rx(-pi/2) q[8];
rz(pi/4) q[8];
rxx(pi/2) q[6],q[8];
...
ry(pi/2) q[6];
rz(-pi/2) q[6];
rz(0.3724273171153576) q[9];
ry(2.279588186718979) q[9];
rz(-1.030254809439339) q[9];
rxx(pi/2) q[8],q[9];
rz(-pi) q[8];
rx(-pi/2) q[8];
rz(-3.0805619529457005) q[9];
ry(3.0197579433158466) q[9];
rz(-0.061030700644087776) q[9];
rxx(pi/2) q[8],q[9];
rz(-pi/2) q[8];
ry(2.183787287594688) q[8];
rxx(pi/2) q[7],q[8];
rx(-pi/2) q[8];
rz(-pi/4) q[8];
rz(0.2915329190630547) q[9];
ry(1.2909196602735817) q[9];
rz(0.7440456791057066) q[9];
rxx(pi/2) q[9],q[8];
rx(-pi/2) q[8];
rz(pi/4) q[8];
rxx(pi/2) q[7],q[8];
...
rx(-pi/2) q[7];
ry(pi/2) q[7];
rz(-2.805934613826279) q[9];
ry(2.2951919375878633) q[9];
rz(-1.0862255486387142) q[9];
rxx(pi/2) q[8],q[9];
rz(-pi) q[8];
rx(-pi/2) q[8];
rz(-3.0805619529457005) q[9];
...
rxx(pi/2) q[8],q[9];
rz(-pi/2) q[8];
ry(2.5286016927900032) q[8];
rxx(pi/2) q[7],q[8];
rx(-pi/2) q[7];
rx(-pi/2) q[8];
rz(-pi/4) q[8];
rz(-2.8842134918424778) q[9];
ry(1.8200498445108821) q[9];
rz(2.388614269039558) q[9];
rxx(pi/2) q[9],q[8];
rx(-pi/2) q[8];
rz(pi/4) q[8];
rxx(pi/2) q[7],q[8];
