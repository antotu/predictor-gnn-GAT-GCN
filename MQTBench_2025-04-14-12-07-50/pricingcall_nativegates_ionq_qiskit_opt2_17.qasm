...
rz(-pi/4) q[9];
rxx(pi/2) q[9],q[8];
rz(0.29425236476954186) q[8];
rx(-pi/2) q[8];
rx(-139.80087308474555) q[9];
rxx(pi/2) q[9],q[8];
rz(-0.29425236476954275) q[8];
rx(-pi/2) q[8];
rxx(pi/2) q[9],q[8];
rz(-0.0013469636205263313) q[8];
rx(-pi/2) q[8];
rxx(pi/2) q[9],q[8];
