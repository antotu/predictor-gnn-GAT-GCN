...
cz eval[8],q[0];
rz(-pi/2) q[0];
rx(1.373465864411577) q[0];
rz(pi/2) q[0];
cz eval[9],q[0];
rz(pi/2) q[0];
rx(2.746931728823122) q[0];
rz(-pi/2) q[0];
cz eval[9],q[0];
rz(-pi/2) q[0];
...
cz eval[10],q[0];
rz(-pi/2) q[0];
rx(0.7893218495333322) q[0];
rz(pi/2) q[0];
cz eval[10],q[0];
rz(pi/2) q[0];
rx(0.7893218495333109) q[0];
rz(-pi/2) q[0];
cz eval[11],q[0];
rz(-pi/2) q[0];
rx(1.5786436990665402) q[0];
rz(pi/2) q[0];
cz eval[11],q[0];
rz(pi/2) q[0];
rx(1.5786436990667458) q[0];
rz(-pi/2) q[0];
cz eval[12],q[0];
rz(pi/2) q[0];
rx(3.125897909046176) q[0];
rz(-pi/2) q[0];
cz eval[12],q[0];
rz(-pi/2) q[0];
rx(3.125897909046425) q[0];
rz(pi/2) q[0];
cz eval[13],q[0];
rz(-pi/2) q[0];
rx(0.03138948908665527) q[0];
rz(pi/2) q[0];
cz eval[13],q[0];
rz(pi/2) eval[13];
rx(pi/2) eval[13];
