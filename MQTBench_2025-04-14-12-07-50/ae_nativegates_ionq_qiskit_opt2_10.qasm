...
qreg q[1];
creg meas[10];
rx(-23.555808978771896) eval[0];
rx(-21.978876728825455) eval[1];
rx(-18.825012228932586) eval[2];
rx(-15.658875882736625) eval[3];
rx(-12.46819584393449) eval[4];
rx(-9.228428419920016) eval[5];
rx(-15*pi/8) eval[6];
rx(-3*pi/4) eval[7];
rx(pi/2) eval[8];
