...
qreg psi[1];
creg c[2];
rx(-0.7033772284343405) q[0];
rz(2.5990791927040346) q[1];
rx(3*pi/4) q[1];
rz(3*pi/4) psi[0];
ry(-pi/2) psi[0];
rxx(pi/2) q[0],psi[0];
rz(0.5741202934276579) q[0];
ry(1.0012101734379293) q[0];
rz(-2.4465934408991403) q[0];
rxx(pi/2) q[0],q[1];
