...
dataset = torch.load('../../Geneva-1.pt', weights_only=False)
...
plt.savefig('actual_pred_plot_bestModel_Geneva.pdf', format='pdf', bbox_inches='tight')
plt.close()
...
# Save to PDF
plt.savefig("tsne_plot_bestModel_Geneva.pdf", format="pdf", bbox_inches="tight")
plt.close()
